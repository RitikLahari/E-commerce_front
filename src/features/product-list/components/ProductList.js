...
import { fetchAllProductByFiltersAsync, fetchAllProductByIdAsync, fetchBrandsAsync, fetchCategoriesAsync, fetchProductByIdAsync, fetchProductsByFiltersAsync, selectAllProduct ,selectBrands,selectCategories,selectTotalItems,} from '../ProductListSlice';
...
function ProductGrid({ products }) {
  return (
    ...
    <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
      ...
      <div className="mt-6 grid grid-cols-1 gap-x-0 gap-y-0 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
          ...
          <div key={product.id} className="group relative">
            ...
            <div className="mt-4 flex justify-between">
              <div>
                ...
                <StarIcon className='h-4 w-3 inline'/>
